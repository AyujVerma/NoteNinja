...
cred = credentials.Certificate("./env/hacktx2023-402718-00c323ae8bf1.json")
initialize_app(cred, {'storageBucket': 'hacktx2023-402718.appspot.com'})
...
def runner(audio, ppt):
    # how get input??
    audio_uri = 'gs://hacktx2023-402718.appspot.com/audio/' + audio
    slides_uri = 'gs://hacktx2023-402718.appspot.com/slides/' + ppt
    segment_and_output(audio_uri, slides_uri)